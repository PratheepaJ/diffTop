...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(57, 55, "end", "model_lda");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lda
  : public stan::model::model_base_crtp<model_lda> {
private:
        int K;
        int V;
        int D;
...
public:
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            validate_non_negative_index("x_sim", "D", D);
            validate_non_negative_index("x_sim", "V", V);
            std::vector<std::vector<int> > x_sim(D, std::vector<int>(V, int(0)));
            stan::math::fill(x_sim, std::numeric_limits<int>::min());
            current_statement_begin__ = 42;
            validate_non_negative_index("log_lik", "D", D);
            Eigen::Matrix<double, Eigen::Dynamic, 1> log_lik(D);
            ...
            for (int d = 1; d <= D; ++d) {
                ...
                stan::model::assign(x_sim, 
                            ...
                            multinomial_rng(eta, sum(get_base1(n, d, "n", 1)), base_rng__), 
                            "assigning variable x_sim");
                current_statement_begin__ = 53;
                stan::model::assign(log_lik, 
                            stan::model::cons_list(stan::model::index_uni(d), stan::model::nil_index_list()), 
                            multinomial_log(get_base1(n, d, "n", 1), eta), 
                            "assigning variable log_lik");
                }
            }
            // validate, write generated quantities
            current_statement_begin__ = 41;
            size_t x_sim_i_0_max__ = D;
            size_t x_sim_i_1_max__ = V;
            for (size_t i_0__ = 0; i_0__ < x_sim_i_0_max__; ++i_0__) {
                for (size_t i_1__ = 0; i_1__ < x_sim_i_1_max__; ++i_1__) {
                    check_greater_or_equal(function__, "x_sim[i_0__][i_1__]", x_sim[i_0__][i_1__], 0);
                }
            }
            size_t x_sim_k_0_max__ = D;
            size_t x_sim_k_1_max__ = V;
            for (size_t k_1__ = 0; k_1__ < x_sim_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < x_sim_k_0_max__; ++k_0__) {
                    vars__.push_back(x_sim[k_0__][k_1__]);
                }
            }
            current_statement_begin__ = 42;
            size_t log_lik_j_1_max__ = D;
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t k_1__ = 0; k_1__ < x_sim_k_1_max__; ++k_1__) {
            for (size_t k_0__ = 0; k_0__ < x_sim_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "x_sim" << '.' << k_0__ + 1 << '.' << k_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        size_t log_lik_j_1_max__ = D;
