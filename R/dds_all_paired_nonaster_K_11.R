#' \code{'DESeqDataSet'} object for the differential topic analysis on all non-Asteraceae paired-samples in psE_BARBI.
#'
...
#' @examples
#' \dontrun{
#' results(dds_all_paired_nonaster_K_11)
#' }
"dds_all_paired_nonaster_K_11"
