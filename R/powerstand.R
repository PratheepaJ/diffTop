#' A vector
#'
#' Contais the number of pvalues (out of 1000) less than 0.05 and 0.01 for the PERMANOVA in the simulated data without strain switching.
#'
#'
...
#' @examples
#' \dontrun{
#' print(round(powerstand[1]/1000,2))
#' }
"powerstand"
