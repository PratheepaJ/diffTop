...
Here, we are interested infer on the topics (bacterial communities) when we use original and modified PNA clams (two different experimental conditions). To infer about these topics, we use latent Dirichlet allocation.  
